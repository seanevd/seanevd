	...
	exports.render = function( imagedata , filename , filenamenoext , isSvg , width , height , type , o) {
		...
		page.open(  o.inputdir + filename, function( status ){
			if( status === "success" ){
				...
				// create png file in different versions
				if(o.pngpixelratio && o.pngpixelratio.length > 0) {
					var pxstring;
					for(var i = 0; i < o.pngpixelratio.length; i++) {
						page.zoomFactor = o.pngpixelratio[i];
						pxstring = ( ( o.pngpixelratio[i] === '1' || o.pngpixelratio.length === 1 ) ? '' : ('-' + o.pngpixelratio[i] + 'x' ) );
						page.render( o.outputdir + o.pngout + filenamenoext + pxstring + ".png" );
					}
				} else {
					// create png file
